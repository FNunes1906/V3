...
/** Magic method which allows read-only access to protected or private class properties
  ...
  * @return mixed */
    ...
    public function __construct() {
		...
		//$this->config['uploadURL'] = "/partner/masterdefaultv3/images/";
		# Yogi: THIS FILE MAY NOT WORK, WE ARE USING D:\wamp\www\v3\manage\protected\extensions\editMe\vendors\CKEditor\kcfinder\core\class\uploader.php Include Database file to fetch partner folder name and Site URL and setpath for the same
		include("../../../../../config/database.php");
		$uploadurl_tw = "http://".$pageURL_actual."/partner/".$_SESSION['partner_folder_name']."/images/";
		$this->config['uploadURL'] = $uploadurl_tw;
