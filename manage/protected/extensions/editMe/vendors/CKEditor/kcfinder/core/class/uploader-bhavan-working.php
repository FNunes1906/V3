...
/** Magic method which allows read-only access to protected or private class properties
  ...
  * @return mixed */
    ...
    public function __construct() {
        ...
        $this->config = $_CONFIG;
// bhavan: i uncommented out the following
...
// bhavan: we want to keep it at uploadDir level
...
// bhavan: as per http://civicrm.stackexchange.com/questions/6576/error-unknown-error-when-uploading-a-file-with-ckeditor
// this function does not allow link to be part of file path. so let's return true
//echo $file;
//exit($file);
return True;
        $rPath = realpath($file);
