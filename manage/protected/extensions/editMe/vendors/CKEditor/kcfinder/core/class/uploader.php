...
/** Magic method which allows read-only access to protected or private class properties
  ...
  * @return mixed */
    ...
    public function __construct() {
        ...
        # Yogi: Include Database file to fetch partner folder name and Site URL and setpath for the same
    ...
    protected function checkFilePath($file) {
        return true; // Yogi: Put this line because of realpath function was creating issue so this will not go beyond this point
        $rPath = realpath($file);
