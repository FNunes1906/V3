...
digitalspaghetti.password = {	
	'defaults' : {
		...
		'colors': ["#dd514c", "#dd514c", "#faa732", "#0e90d2", "#5eb95e"],
		'btmone': ["#ee5f5b", "#ee5f5b", "#fbb450", "#149bdf", "#62c462"],
		'btmtwo': ["#c43c35", "#c43c35", "#f89406", "#0480be", "#57a957"],
		'scores': [20, 30, 43, 50],
		'verdicts':	['Low', 'Normal', 'Good', 'Strong', 'Very Strong'],
		'raisePower': 1.4,
		'debug': false
	},
	'ruleScores' : {
	...
	'calculateScore': function (word) {
		...
		for (var key in digitalspaghetti.password.rules) if (digitalspaghetti.password.rules.hasOwnProperty(key)) {
			...
			if (digitalspaghetti.password.totalscore <= digitalspaghetti.password.options.scores[0]) {
				...
				digitalspaghetti.password.btmone = digitalspaghetti.password.options.btmone[0];
				digitalspaghetti.password.btmtwo = digitalspaghetti.password.options.btmtwo[0];
				...
				digitalspaghetti.password.btmone = digitalspaghetti.password.options.btmone[1];
				digitalspaghetti.password.btmtwo = digitalspaghetti.password.options.btmtwo[1];
				...
				digitalspaghetti.password.btmone = digitalspaghetti.password.options.btmone[2];
				digitalspaghetti.password.btmtwo = digitalspaghetti.password.options.btmtwo[2];
				...
				digitalspaghetti.password.btmone = digitalspaghetti.password.options.btmone[3];
				digitalspaghetti.password.btmtwo = digitalspaghetti.password.options.btmtwo[3];
				...
				digitalspaghetti.password.btmone = digitalspaghetti.password.options.btmone[4];
				digitalspaghetti.password.btmtwo = digitalspaghetti.password.options.btmtwo[4];
			...
			jQuery('.password-strength-bar').animate({opacity: 0.5}, 'fast', 'linear', function () {
				jQuery(this).css({'color':'#fff','transition':'width 0.6s ease 0s','background-repeat':'x','border-radius':'2px','margin-top':'5px','padding':'5px','display': 'block', 'background-color':'digitalspaghetti.password.strColor','background-image': 'linear-gradient(to bottom,'+ digitalspaghetti.password.btmone + ','+ digitalspaghetti.password.btmtwo + ')', 'width': digitalspaghetti.password.width + "%"}).text(digitalspaghetti.password.strText);
