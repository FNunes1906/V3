$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName != 'classic') {
            $('#bs-css').attr('href', 'http://'+$(location).attr('hostname')+'/manage/themes/twtheme/css/bootstrap-' + themeName + '.min.css');
        } else {
			 $('#bs-css').attr('href', 'http://'+$(location).attr('hostname')+'/manage/themes/twtheme/bower_components/bootstrap/dist/css/bootstrap.min.css');
        }
