...
function load_config(){
	...
	$var->site_name =   isset($pageglobal['site_name'])?$pageglobal['site_name']:'';
	$var->beach =   isset($pageglobal['beach'])?$pageglobal['beach']:'';
	$var->email =   isset($pageglobal['email'])?$pageglobal['email']:'';
	$var->googgle_map_api_keys = $gmapkeys1[0];
	$var->location_code =   isset($pageglobal['location_code'])?$pageglobal['location_code']:'';
	$var->photo_mini_slider_cat =   isset($pageglobal['photo_mini_slider_cat'])?$pageglobal['photo_mini_slider_cat']:'';
	$var->photo_upload_cat =   isset($pageglobal['photo_upload_cat'])?$pageglobal['photo_upload_cat']:'';
	$var->facebook =   isset($pageglobal['facebook'])?$pageglobal['facebook']:'';
	$var->iphone =   isset($pageglobal['iphone'])?$pageglobal['iphone']:'';
	$var->android =   isset($pageglobal['android'])?$pageglobal['android']:'';
	$var->twitter =   isset($pageglobal['twitter'])?$pageglobal['twitter']:'';
	$var->youtube =   isset($pageglobal['youtube'])?$pageglobal['youtube']:'';
	$var->googgle_analytics=  isset($pageglobal['googgle_map_api_keys'])?$pageglobal['googgle_map_api_keys']:'';
	$var->Header_color =  isset($pageglobal['Header_color'])?$pageglobal['Header_color']:'';
	$var->Footer_Menu_Link=  isset($pageglobal['Footer_Menu_Link'])?$pageglobal['Footer_Menu_Link']:'';
	$var->distance_unit= isset($pageglobal['dunit'])?$pageglobal['dunit']:'';
	$var->weather_unit=  isset($pageglobal['title'])?$pageglobal['wunit']:'';
	$var->time_zone=  isset($pageglobal['title'])?$pageglobal['timezone']:'';
	...
	$var->timezone =   isset($pageglobal['time_zone'])?$pageglobal['time_zone']:'';
  
	/*  Varialbel added for Date format - Akash 16/7/2013 */
	$var->timeformat =   isset($pageglobal['time_format'])?$pageglobal['time_format']:'';
}
...
function m_featured_event(){
	global $var;
	//  echo $var->timezone;
	//  echo $tq = "select TIMESTAMP(CURRENT_TIMESTAMP,'$var->timezone')";
	//  $result = mysql_fetch_array(mysql_query($tq));
	//  echo $result[0];
