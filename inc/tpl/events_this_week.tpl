<h2>This Week in <?php echo $var->beach; ?></h2>
...
<br />
<a class="button" href="events.php" style="float:left; margin-right:10px;">more events</a>
...
<a class="button" style="float:left;" href="/events_submit.php">Send Us Your Events</a>
