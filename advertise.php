...
<div id="wrapper">
	...
	<div id="my_area" style="padding:15px; width:680px;"><p>
		<iframe name="I1" src="http://<?php echo $_SERVER["HTTP_HOST"]; ?>/index.php?option=com_rsform&formId=2&tmpl=component" width="650" height="750" frameborder="0" scrolling="no">
			Your browser does not support inline frames or is currently configured not to display inline frames.
		</iframe>											
	</p></div>
    
    <?php //m_article('Advertise'); ?>
	</section> <!-- rightColumn -->
</div> <!-- wrapper -->
<footer>
	<?php m_footer(); ?> <!-- footer -->
