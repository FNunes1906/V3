...
class Pageglobal extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('site_name, email, googgle_map_api_keys, location_code, beach, photo_mini_slider_cat, photo_upload_cat, facebook, iphone, android, Header_color, distance_unit, weather_unit, twitter, youtube, date_format, time_format, homeslidercat', 'required'),
			array('homeslidercat', 'numerical', 'integerOnly'=>true),
			array('site_name, email, location_code, beach, photo_mini_slider_cat, photo_upload_cat, facebook, iphone, android, Header_color, Footer_Menu_Link, distance_unit, weather_unit, twitter, youtube, date_format, time_format', 'length', 'max'=>255),
	...
	public function attributeLabels()
	{
		return array(
			...
			'site_name' => 'Site Name',
			'email' => 'Email',
			'googgle_map_api_keys' => 'Googgle Map Api Keys',
			'location_code' => 'Location Code',
			'beach' => 'Beach',
			'photo_mini_slider_cat' => 'Photo Mini Slider Cat',
			'photo_upload_cat' => 'Photo Upload Cat',
			'facebook' => 'Facebook',
			'iphone' => 'Iphone',
			'android' => 'Android',
