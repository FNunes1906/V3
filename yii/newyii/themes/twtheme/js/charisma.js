$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', 'http://www.twadmin3.com/themes/twtheme/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'http://www.twadmin3.com/themes/twtheme/css/bootstrap-' + themeName + '.min.css');
        }
