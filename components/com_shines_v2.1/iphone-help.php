...
function help_intro() {
	$db = JFactory::getDBO();
	$db->setQuery("select `introtext` from `jos_content` where `title` = 'App Help & Support'");
	$content = $db->query();
...
?>
	...
	<meta property="og:title" content="<?php echo utf8_encode($site_name).' | Help';?>"/>
	...
	<title><?php echo utf8_encode($site_name).' | Help';?></title>
