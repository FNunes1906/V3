		...
		<?php if($article_res){ ?>
		 	<li style="text-align:left;">
				...
				?>						
					...
					<!-- Facebook -->
					<li class="button-wrap"><a  class="addthis_button_facebook" addthis:url="<?php echo $url;?>"></a></li>

					<!-- Twitter -->
					<li class="button-wrap"><a class="addthis_button_twitter" addthis:url="<?php echo $url;?>"></a></li>

					<!-- Google -->
					<li class="button-wrap"><a class="addthis_button_google_plusone_share" addthis:url="<?php echo $url;?>"></a></li>

					<!-- Email -->
					<li class="button-wrap"><a class="addthis_button_email" addthis:url="<?php echo $url;?>"></a></li>
