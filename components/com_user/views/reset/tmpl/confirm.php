...
<form style="clear: both; padding-top: 12px;" action="<?php echo JRoute::_( 'index.php?option=com_user&task=confirmreset' ); ?>" method="post" class="josForm form-validate">
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="contentpane">
		...
		<tr>
			...
			<td>
				<input value="<?php echo $_REQUEST['token']; ?>" id="token" name="token" type="text" class="required" size="36" />
			</td>
		</tr>
	</table>
