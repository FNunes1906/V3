...
class JAdminCSSMenu extends JTree
{
	...
	function renderLevel($depth)
	{
		 ...
		 */
		if (($this->_current->link != null && $usertype == 'TW_Admin' && $this->_current->title == 'JEV People') || ($this->_current->link != null && $usertype == 'TW_Admin' && $this->_current->title == 'Install/Uninstall') || ($this->_current->link != null && $usertype == 'TW_Admin' && $this->_current->title == 'PHP Pages') || ($this->_current->link != null && $usertype == 'TW_Admin' && $this->_current->title == 'Categories') || ($this->_current->link != null && $usertype == 'TW_Admin' && ($this->_current->title == 'Themes' || $this->_current->title == 'Category Rating' || $this->_current->title == 'Image Rating' || $this->_current->title == 'Category Comments' || $this->_current->title == 'Image Comments' || $this->_current->title == 'Users' || $this->_current->title == 'Info')) || ($this->_current->link != null && $usertype == 'TW_Admin' && ($this->_current->title == 'Configuration' || $this->_current->title == 'Updates' || $this->_current->title == 'Plugins')) || ($this->_current->link != null && $usertype == 'TW_Admin' && $this->_current->title == 'Search') || ($this->_current->link != null && $usertype == 'TW_Admin' && $this->_current->title == 'Shines') || ($this->_current->link != null && $usertype == 'TW_Admin' && $this->_current->title == 'Category Manager') || ($this->_current->link != null && $usertype == 'TW_Admin' && $this->_current->title == 'Section Manager')) {
			echo "<span></span>";
