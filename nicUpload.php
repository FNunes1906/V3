...
# code to get partner folder name start
...
if (mysql_num_rows($result) > 0) {
	...
	$partnerFolderName 	= $row['partner_folder_name'];
}
mysql_close($link);
# code to get partner folder name end
...
define('NICUPLOAD_PATH', $_SERVER['DOCUMENT_ROOT'].'/partner/'.$partnerFolderName.'/images/stories'); // Set the path (relative or absolute) to
                                      // the directory to save image files

define('NICUPLOAD_URI', 'http://'.$pageURL_actual.'/partner/'.$partnerFolderName.'/images/stories');   // Set the URL (relative or absolute) to
