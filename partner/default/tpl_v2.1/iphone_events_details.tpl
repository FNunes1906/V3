...
<div id="main" role="main" ontouchstart="touchStart(event,'list');"  ontouchmove="touchMove(event);" ontouchcancel="touchCancel(event);">
	<ul id="placesList" class="mainList"><li>
	   ...
	   /* End By Akash */	
		...
		<p><strong>Distance:</strong> <?php echo round(distance(isset($_SESSION['lat_device1']), isset($_SESSION['lon_device1']), $lat2, $lon2,$dunit),'1')?>&nbsp;<?php echo $dunit;?></p>
		...
		<?php  	header('Content-type: text/html;charset=ISO-8859-1', true);
				$cal_date=date('m-d-Y', mktime(0, 0, 0, $tomonth, $today, $toyear)); ?>		
