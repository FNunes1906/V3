<div id="main" role="main">
	<div id="searchBar">
		<form id="placeCatForm" method="GET">
			<?php $recsubsql="select * from jos_categories where (parent_id=".$category_id." OR id=".$category_id.") AND section='com_jevlocations2' and published=1 ORDER BY title ASC";
