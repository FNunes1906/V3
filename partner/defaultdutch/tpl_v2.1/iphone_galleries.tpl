...
<div id="content">
	<ul class="mainList" id="placesList">
	 ...
	 <img class="photo_container" src="<?php echo $v['avatar']; ?>" alt="<?php echo $v['title']; ?>" title="<?php echo $v['title']; ?>" /></a>
	</td>
		<td valign="middle;">
		&nbsp;&nbsp;
	     <font color="#999999">
	     <strong><a href="photos.php?id=<?php echo $v['id']?>"><?php echo $v['title']?></a></strong></font> 
	     </td></tr></table>
	     </li>
	     <?php } }  ?>
	</ul>
