...
<div id="featuredEvents">
	<div class="flexslider-container">
		...
		/*	$homeslider1[$k]['timestart'] = $fearow['timestart'];
			...
			?> 
		    	<li>
				<a href="/components/com_shines_v2.1/events_details.php?eid=<?php echo $fearow['rp_id'];?>&y=<?php echo $fearow['Eyear'];?>&m=<?php echo $fearow['Emonth'];?>&d=<?php echo $fearow['EDate'];?>&lat=<?php echo $lat1;?>&lon=<?php echo $lon1;?>"><img src="<?php echo $singleimagearray[0];?>" /></a>
...
<div class="section">
	...
	<form name='events' id='events' action='generic_events.php?category_id=<?php echo $_REQUEST[category_id] ?>' method='post'>
		...
		<button data-theme="a" id="show" class="ui-btn-hidden button" aria-disabled="false" style="width:100%;">Filtriranje po datumu </button>
	</form>
