        ...
        <ul>
			...
			?> 
		    	...
		    	<li id="item<?php echo $imagecount;?>" class="<?php echo $imagecount;?>">
					<div class="event">
					<a href="/index.php?option=com_jevlocations&task=locations.detail&loc_id=<?php echo $fearow['loc_id'];?>&se=1&title=<?php echo $fearow['alias'];?>&Itemid=<?php echo $_REQUEST[Itemid];?>"><img style="height:268px; width: 100%;" src="<?php echo $singleimagearray;?>" /></a>
		    		<div class="infoCont">
